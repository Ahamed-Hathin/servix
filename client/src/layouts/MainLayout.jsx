...
const footerLinks = [
    ...
    {
        title: "Company",
        links: ["About Us", "Careers", "Blog", "Press", "Terms", "Privacy"],
    },
    {
        title: "Support",
        links: [
...
export default function MainLayout() {
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            <footer className="bg-gray-900 dark:bg-gray-950 text-gray-400 pt-16 pb-8 transition-colors duration-300">
                        ...
                        <div className="col-span-2">
                            <Link to="/" className="flex items-center gap-2 mb-5">
                                ...
                                <span className="font-bold text-xl text-white">
                                    Ser
                                    <span className="text-primary-400">vix</span>
                                </span>
                            </Link>
                            ...
                            <div className="space-y-3 mb-6">
                                ...
                                <div className="flex items-start gap-2.5">
                                    <HiOutlineMapPin className="w-4 h-4 text-primary-400 shrink-0 mt-0.5" />
                                    <span className="text-sm">
                                        Chennai, Coimbatore, Madurai, Salem,
                                        Tiruchirappalli, Vellore & more
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                {socialLinks.map((social, i) => (
                                    <button
                                        ...
                                        className="w-9 h-9 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200 cursor-pointer"
                                    >
                                        {social.icon}
                                    </button>
                                ))}
                            ...
                            <div key={i}>
                                ...
                                <ul className="space-y-2.5">
                                    {col.links.map((link, j) => (
                                        <li key={j}>
                                            <span className="text-sm hover:text-white hover:translate-x-0.5 inline-block transition-all cursor-pointer">
                                                {link}
                                            </span>
                                        </li>
                                    ))}
